...
<div class=link-oldal>
    <div class="container">
        <h2>Képi lélegeztetés</h2>
        <div class="row">
            <?php 
            require 'connect.php';

            $sql = "SELECT link, Link_ID FROM linkmegoszt WHERE tipus=1 ORDER BY Link_ID DESC;";
            ...
            if ($resultCeck > 0) {
                while($row = mysqli_fetch_assoc($result))
                {
                    ...
                    echo '<a href="link-torles.php?id=' .$row['Link_ID'] .'&type=1">Törlés</a>';
